...
if (!finddd) return api.sendMessage("Bạn không quản trị viên box ?", event.threadID, event.messageID);  
if(!find) {api.sendMessage("Bot không phải qtv", event.threadID, event.messageID)}
