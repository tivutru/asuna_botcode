...
module.exports.run = async ({ event, api, args }) => {
  ...
  try {
    if(global.client == true) return api.sendMessage("Hệ thống đang xử lý yêu cầu từ box khác, vui lòng quay lại sau", event.threadID, event.messageID);
    global.client = true;
